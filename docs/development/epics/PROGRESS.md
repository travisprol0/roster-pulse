...
| Status | ID | Title | Notes |
| ------ | -- | ----- | ----- |
| Not started | TRADE-001-01 | Filter opponent / position | Depends on USE-001-02 + TRADE-001-02 |
| Not started | TRADE-001-02 | Counterpart team on every row | — |
...
| Status | ID | Title | Notes |
| ------ | -- | ----- | ----- |
| Not started | SYNC-001-01 | Refresh + last-synced | Submit-to-sync already ships |
| Not started | SYNC-001-02 | Visible sync errors | — |
